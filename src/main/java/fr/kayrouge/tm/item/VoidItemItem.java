...
import fr.kayrouge.tm.gui.VoidItemGuiGui;
import fr.kayrouge.tm.TmModElements;

@TmModElements.ModElement.Tag
public class VoidItemItem extends TmModElements.ModElement {
	@ObjectHolder("tm:void_item")
	public static final Item block = null;
	public VoidItemItem(TmModElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(MainTabItemGroup.tab).maxStackSize(1));
			setRegistryName("void_item");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Void Item");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new VoidItemGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
