...
public class VoidBlockMaterialBlock extends TmModElements.ModElement {
	@ObjectHolder("tm:void_block_material")
	public static final Block block = null;
	public VoidBlockMaterialBlock(TmModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1.45f, 14f).lightValue(0).harvestLevel(2)
					.harvestTool(ToolType.PICKAXE).doesNotBlockMovement().notSolid());
			setRegistryName("void_block_material");
		}
