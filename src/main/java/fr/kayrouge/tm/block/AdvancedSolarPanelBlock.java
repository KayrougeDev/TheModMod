...
import fr.kayrouge.tm.procedures.AdvancedSolarPanelUpdateProcedureProcedure;
import fr.kayrouge.tm.itemgroup.MainTabItemGroup;
import fr.kayrouge.tm.TmModElements;

@TmModElements.ModElement.Tag
public class AdvancedSolarPanelBlock extends TmModElements.ModElement {
	@ObjectHolder("tm:advanced_solar_panel")
	public static final Block block = null;
	public AdvancedSolarPanelBlock(TmModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("advanced_solar_panel");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				AdvancedSolarPanelUpdateProcedureProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	}
