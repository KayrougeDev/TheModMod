...
public class EnergyBlockUpdateTickProcedure extends TmModElements.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure EnergyBlockUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure EnergyBlockUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure EnergyBlockUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure EnergyBlockUpdateTick!");
			return;
		}
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z + 1)))).getBlock() == RFcableOFFBlock.block.getDefaultState().getBlock())) {
			if (!world.isRemote) {
				...
				if (_tileEntity != null)
					...
					}.getValue(new BlockPos((int) x, (int) y, (int) (z + 1)), "energy")) + 12));
